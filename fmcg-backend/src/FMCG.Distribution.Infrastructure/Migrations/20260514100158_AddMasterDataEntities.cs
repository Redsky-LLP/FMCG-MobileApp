        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedSalesmanId = table.Column<Guid>(type: "uuid", nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Routes_Users_AssignedSalesmanId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameMalayalam = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_NameMalayalam",
                table: "Customers",
                column: "NameMalayalam");

            migrationBuilder.CreateIndex(
                name: "IX_Customers_RouteId_SequenceOrder",
                table: "Customers",
                columns: new[] { "RouteId", "SequenceOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_Products_NameMalayalam",
                table: "Products",
                column: "NameMalayalam");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Routes_AssignedSalesmanId",
                table: "Routes",
